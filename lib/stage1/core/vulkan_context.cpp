...
void VulkanContext::CreateDebugMessenger() {
    ...
    if (vkCreateDebugUtilsMessenger &&
        vkCreateDebugUtilsMessenger(m_vkInstance, &createInfo, nullptr, &m_debugMessenger) !=
            VK_SUCCESS) {
...
void VulkanContext::BuildVkFeatures() {
    ...
    BuildVkExtensionChain(m_physDevFeatures, m_vulkan11Features, m_vulkan12Features,
                          m_vulkan13Features);
    // サポート情報を取得
